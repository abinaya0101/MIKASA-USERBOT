...
CmdHelp("core").add_command(
  ...
  "uninstall", "<plugin name>", "Uninstalls the given plugin from Dєα∂ly Bσт. To get that again do .restart", "uninstall alive"
).add_command(
